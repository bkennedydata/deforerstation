# deforerstation
This SQL project sought to analyse the findings of a SQL deforestation dataset.  Anlysing global deforestaion on regional and country level and providing written reccomendations from these findings.
